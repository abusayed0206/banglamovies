...
const fetchMovieDetails = async (tmdbId: string): Promise<Movie> => {
  ...
  return {
    ...
    videos: enData.videos, // Use English videos
  };
};
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="p-6 text-center">
        ...
        <h1 className="text-4xl font-bold mb-4 mt-8">
          {movie.title}{" "}
          <span className="text-lg font-normal">({releaseYear})</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          <p>
            <strong>মুক্তির বছর:</strong> {releaseYear}
          </p>
          <p>
          ...
          <p>
            <strong>সময়কাল:</strong> {movie.runtime} মিনিট
          </p>
          <p>
